...
$options[] = array(
	...
	'fields' => array(
		...
		array(
			'id'=>'slider_items',
			'type'=>'group',
			'title'=>'Slider Section Items',
			'button_title'=>'Add New',
			'accordion_title'=>'Add New Slider Group',
			'fields'=>array(
				array(
					'id'=>'slider_item_text',
					'type'=>'text',
					'title'=>'Slider Item Text',
				),
				array(
					'id'=>'slider_item_highlight_text',
					'type'=>'text',
					'title'=>'Slider Item Highlight Text',
				),
				array(
					'id'=>'slider_item_subtext',
					'type'=>'text',
					'title'=>'Slider Item Sub Text',
				),
				array(
					'id'=>'slider_item_image',
					'type'=>'image',
					'title'=>'Slider Item Image',
				),
			),
		),
	),
...
$options[]		= array(
	...
	'fields'=>array(
		...
		array(
			'id'=>'port_menu',
			'type'=>'text',
			'title'=>'Portfolio Menu Text',
		),
		array(
			'id'=>'team_menu',
			'type'=>'text',
			'title'=>'Team Menu Text',
		),
		array(
			'id'=>'pricing_menu',
			'type'=>'text',
			'title'=>'Pricing Menu Text',
		),
		array(
			'id'=>'blog_menu',
			'type'=>'text',
...
$options[]		= array(
	...
	'fields'=>array(
		...
		array(
			'id'=>'ser_group',
			'type'=>'group',
			'title'=>'Service Group First Row',
			'button_title'=>'Add New',
			'accordion_title'=>'Add New Service Group',
			'fields'=>array(
				array(
					'id'=>'ser_gro_title',
					'type'=>'icon',
				...
				array(
					'id'=>'ser_gro_icon',
					'type'=>'text',
					'title'=>'Write Service Text',
				),
				array(
					'id'=>'ser_gro_desc',
					'type'=>'textarea',
					'title'=>'Write Service Description',
				),
			),
		),
		array(
			'id'=>'ser_group_s',
			'type'=>'group',
			'title'=>'Service Group Second Row',
			'button_title'=>'Add New',
			'accordion_title'=>'Add New Service Group',
			'fields'=>array(
				array(
...
$options[]		= array(
	...
	'fields'=>array(
		...
		array(
			'id'=>'about_desc_first',
			'type'=>'textarea',
			'title'=>'About Section First Description',
		),
		array(
			'id'=>'about_desc_sec',
			'type'=>'textarea',
		...
		array(
			'id'=>'about_parallax',
			'type'=>'upload',
			'title'=>'Upload Background Paralax Image',
		),
		array(
			'id'=>'about_group',
			'type'=>'group',
			'title'=>'About Group',
			'button_title'=>'Add New',
			'accordion_title'=>'Add New Experience Group',
			'fields'=>array(
				array(
					'id'=>'about_gro_title',
					'type'=>'text',
				...
				array(
					'id'=>'about_gro_percent',
					'type'=>'text',
					'title'=>'Experience Percent',
				),
...
$options[]		= array(
	...
	'fields'=>array(
		...
		array(
			...
			'button_title'=>'Add New',
			'accordion_title'=>'Add New Portfolio Item',
			'fields'=>array(
				array(
					'id'=>'portfolio_image',
					'type'=>'upload',
					'title'=>'Upload Portfolio Item Image',
				),
				array(
				...
				array(
					...
					'type'=>'text',
					'title'=>'Portfolio Item Link',
				),
				array(
					'id'=>'animation_delay',
					'type'=>'text',
					'title'=>'Portfolio Item Animation Delay Mili Second',
				),
				array(
					'id'=>'animation_effect',
					'type'=>'select',
					...
					'options'=>array(
						'fadeInRightBig'=>'Fade In Right',
						'fadeInLeftBig'=>'Fade In Left',
						),
					'default_option'=>'Select Any One',	
					),
				),
...
$options[]	=	array(
	...
	'fields'=>array(
		...
		array(
			...
			'title'=>'Team Group',
			'button_title'=>'Add New',
			'accordion_title'=>'Add New Team Member',
			'fields'=>array(
				array(
					'id'=>'t_Member_image',
					'type'=>'upload',
				...
				array(
					'id'=>'t_Member_name',
					'type'=>'text',
					'title'=>'Write Team Member Name',
				),
				array(
					'id'=>'t_Member_desig',
					'type'=>'text',
					'title'=>'Write Team Member Designation',
				),
				array(
					'id'=>'t_Member_desc',
					'type'=>'textarea',
					'title'=>'Write Team Member Description',
				),
				array(
					'id'=>'t_member_fb',
					'type'=>'text',
					'title'=>'Write Team Member Facebook Link',
				),
				array(
					'id'=>'t_member_twitter',
					'type'=>'text',
					'title'=>'Write Team Member Twitter Link',
				),
				array(
					'id'=>'t_member_li_in',
					'type'=>'text',
					'title'=>'Write Team Member Linked In Link',
				),
				array(
					'id'=>'t_member_dribble',
					'type'=>'text',
					'title'=>'Write Team Member Dribble Link',
				),
				array(
					'id'=>'t_member_rss',
					'type'=>'text',
					'title'=>'Write Team Member RSS Link',
				),
				array(
					'id'=>'t_ani_delay',
					'type'=>'text',
					'title'=>'Write Animation Delay Mili Second',
				),
				),
...
//Feature Count section

$options[]	=	array(
	'name'=>'feature_section',
	'title'=>'Feature Count Section',
	'icon'=>'fa fa-code',
	'fields'=>array(
		array(
			'type'=>'heading',
		...
		array(
			...
			'title'=>'Count Group',
			'button_title'=>'Add New',
			'accordion_title'=>'Add New Count Group',
			'fields'=>array(
				array(
					'id'=>'f_cou_icon',
					'type'=>'icon',
					'title'=>'Select Icon for Count Group',
				),
				array(
					'id'=>'f_cou_numb',
					'type'=>'text',
					'title'=>'Write Number for Count Group',
				),
				array(
					'id'=>'f_cou_title',
					'type'=>'text',
					'title'=>'Write Name for Count Group',
				),
				array(
					'id'=>'f_cou_ani_delay',
					'type'=>'text',
...
$options[] = array(
	...
	'fields'=>array(
		...
		array(
			'type'=>'heading',
			'content'=>'Basic Pricing Table',
		),
		array(
			'id'=>'basic_title',
			'type'=>'text',
			'title'=>'Basic Pricing Title',
		),
		array(
			'id'=>'basic_currency',
			'type'=>'text',
			'title'=>'Basic Pricing  Currency',
		),
		array(
			'id'=>'basic_price',
			'type'=>'text',
			'title'=>'Basic Pricing  Price',
		),
		array(
			'id'=>'basic_duration',
			'type'=>'text',
			'title'=>'Basic Pricing  Duration',
		),
		array(
		  'id'              => 'basic_group',
		  'type'            => 'group',
		  'title'           => 'Basic Group',
		  'button_title'    => 'Add New',
		  'accordion_title' => 'Add New Basic Item',
		  'fields'          => array(
			array(
			  'id'    => 'basic_item',
			  'type'  => 'text',
		...
		array(
			...
			'type'=>'text',
			'title'=>'Basic Button Text',
		),
		array(
			'id'=>'basic_button_link',
			'type'=>'text',
			'title'=>'Basic Button Link',
		),
		array(
			'type'=>'heading',
			'content'=>'Standard Pricing Table',
		),
		array(
			'id'=>'standard_title',
			'type'=>'text',
			'title'=>'Standard Pricing Title',
		),
		array(
			'id'=>'standard_currency',
			'type'=>'text',
			'title'=>'Standard Pricing  Currency',
		),
		array(
			'id'=>'standard_price',
			'type'=>'text',
			'title'=>'Standard Pricing  Price',
		),
		array(
			'id'=>'standard_duration',
			'type'=>'text',
			'title'=>'Standard Pricing  Duration',
		),
		array(
		  'id'              => 'standard_group',
		  'type'            => 'group',
		  ...
		  'button_title'    => 'Add New',
		  'accordion_title' => 'Add New Standard Item',
		  'fields'          => array(
			array(
			  'id'    => 'standard_item',
			  'type'  => 'text',
		...
		array(
			...
			'type'=>'text',
			'title'=>'Standard Button Text',
		),
		array(
			'id'=>'standard_button_link',
			'type'=>'text',
			'title'=>'Standard Button Link',
		),
		array(
			'type'=>'heading',
			'content'=>'Featured Pricing Table',
		),
		array(
			'id'=>'featured_title',
			'type'=>'text',
			'title'=>'Featured Pricing Title',
		),
		array(
			'id'=>'featured_currency',
			'type'=>'text',
			'title'=>'Featured Pricing  Currency',
		),
		array(
			'id'=>'featured_price',
			'type'=>'text',
			'title'=>'Featured Pricing  Price',
		),
		array(
			'id'=>'featured_duration',
			'type'=>'text',
			'title'=>'Featured Pricing  Duration',
		),
		array(
		  'id'              => 'featured_group',
		  'type'            => 'group',
		  ...
		  'button_title'    => 'Add New',
		  'accordion_title' => 'Add New Featured Item',
		  'fields'          => array(
			array(
			  'id'    => 'featured_item',
			  'type'  => 'text',
		...
		array(
			'type'=>'heading',
			'content'=>'Professional Pricing Table',
		),
		array(
		...
		array(
			'id'=>'professional_currency',
			'type'=>'text',
			'title'=>'Professional Pricing  Currency',
		),
		array(
			'id'=>'professional_price',
			'type'=>'text',
			'title'=>'Professional Pricing  Price',
		),
		array(
			'id'=>'professional_duration',
			'type'=>'text',
			'title'=>'Professional Pricing  Duration',
		),
		array(
		  ...
		  'button_title'    => 'Add New',
		  'accordion_title' => 'Add New Professional Item',
		  'fields'          => array(
			array(
			  'id'    => 'professional_item',
			  'type'  => 'text',
		...
		array(
			'id'=>'professional_button_text',
			'type'=>'text',
			'title'=>'Professional Button Text',
		),
		array(
			'id'=>'professional_button_link',
			'type'=>'text',
			'title'=>'Professional Button Link',
		),
	),
);
...
$options[] = array(
	...
	'fields'=>array(
		...
		array(
			'id'=>'contact_desc',
			'type'=>'textarea',
			'title'=>'Contact Heading Description',
		),
		array(
			'id'=>'contact_right_desc',
			'type'=>'textarea',
		...
		array(
			  'id'              => 'contact_group',
			  'type'            => 'group',
			  'title'           => 'Contact Group Field',
			  'button_title'    => 'Add New',
			  'accordion_title' => 'Add New Contact Item',
			  'fields'          => array(
				array(
				  'id'    => 'contact_item_icon',
				  'type'  => 'icon',
				  'title' => 'Choose Icon for Contact Item',
				),
				array(
				  'id'    => 'contact_item_name',
				  'type'  => 'text',
				  'title' => 'Contact item Name',
				),
				array(
				  'id'    => 'contact_item_details',
				  'type'  => 'text',
				  'title' => 'Write Contact Item Details',
				),
			  ),
			),
		),
...
$options[] = array(
	...
	'fields'=>array(
		...
		array(
			  ...
			  'type'            => 'group',
			  'title'           => 'Social Media Group Field',
			  'button_title'    => 'Add New',
